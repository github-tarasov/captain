...
public class CaptainControllerTest {
    ...
    public void crudTest() throws Exception {
        ...
        // check message
        Message<String> received = (Message<String>) messageCollector.forChannel(stream.outputStream()).poll();
        assertEquals("{\"action\":\"setCaptain\",\"teamId\":5,\"participantId\":1,\"participantIdentifier\":\"Иванов Иван\"}", received.getPayload());
        ...
        // check message
        Message<String> received2 = (Message<String>) messageCollector.forChannel(stream.outputStream()).poll();
        assertEquals("{\"action\":\"removeCaptain\",\"teamId\":5,\"participantId\":1,\"participantIdentifier\":\"Иванов Иван\"}", received2.getPayload());
